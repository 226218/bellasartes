...
class Mapos extends CI_Controller {
    ...
    public function index() {
        ...
        $this->data['tipodocumento'] = $this->mapos_model->gettipodocumentoMinimo();
    ...
    public function alterarcontrasenha() {
        ...
        $oldcontrasenha = $this->input->post('oldcontrasenha');
        $contrasenha = $this->input->post('novacontrasenha');
    ...
    public function pesquisar() {
        ...
        $this->data['tipodocumento'] = $data['results']['tipodocumento'];
    ...
    //         $retorno = $this->mapos_model->addEmitente($nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf,$telefono,$email, $logo);
    //         if($retorno){
