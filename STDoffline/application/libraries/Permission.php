 ...
 * c... Cadastrar
 * array de permisos para o autosig.
 */
...
class Permission{
    ...
    var $pk = 'idPermiso';// Nome da chave primaria da tabela
    var $select = 'permisos';// Campo onde fica o array de permisos.
    ...
    private function loadPermission($id = null){
        ...
        if($id != null){
            ...
            if(count($array) > 0){
                ...
                //Atribui as permisos ao atributo permission
