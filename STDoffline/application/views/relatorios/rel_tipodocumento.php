    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a href="<?php echo base_url()?>index.php/relatorios/tipodocumentoRapid"><i class="icon-barcode"></i> <small>Todos los Tipos de Documentos orden Alfabetico</small></a></li>
                    <li><a href="<?php echo base_url()?>index.php/relatorios/tipodocumentoRapidMin"><i class="icon-barcode"></i> <small>Todos los Tipos de Documentos orden de Ingreso</small></a></li>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="span12 well">
                    ...
                    <form action="<?php echo base_url() ?>index.php/relatorios/tipodocumentoCustom" method="get">
                        <div class="span12 well">
                            <div class="span6">
