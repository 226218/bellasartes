    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a href="<?php echo base_url()?>index.php/relatorios/seguimientodocumentoRapid"><i class="icon-tags"></i> <small>Todas los Registros de Tramite Documentario</small></a></li>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="span12 well">
                    ...
                    <form action="<?php echo base_url() ?>index.php/relatorios/seguimientodocumentoCustom" method="get">
                        <div class="span12 well">
                            <div class="span6">
